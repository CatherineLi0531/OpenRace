...
const std::set<llvm::StringRef> noEffect{"cudaConfigureCall",
                                        "cudaSetupArgument"};

inline bool isNoEffect(const llvm::StringRef& funcName) { return noEffect.find(funcName) != noEffect.end(); }
